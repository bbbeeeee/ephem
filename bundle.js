...
/***/ function(module, exports, __webpack_require__) {
	...
	var getRotatedPoint = function getRotatedPoint(x, y, rotationAngle, size) {
	...
	var Birds = function () {
	  function Birds(_ref) {
	    ...
	    setInterval(function () {
	      _this.ctx.clearRect(0, 0, maxX, maxY);
	      ...
	      _this.drawBirds(birds);
	    }, 33);
	  }

	  _createClass(Birds, [{
	    key: 'drawBirds',
	    value: function drawBirds(birds) {
	      birds.forEach(function (bird, index) {
	        bird.draw();
	      });
	    }
	...
	var Bird = function () {
	  function Bird(_ref2) {
	    var type = _ref2.type,
	        ...
	        x = _ref2.x,
	        y = _ref2.y,
	        flapFrame = _ref2.flapFrame,
	        flapFrames = _ref2.flapFrames,
	        velocity = _ref2.velocity,
	        rotationAngle = _ref2.rotationAngle,
	        size = _ref2.size,
	        boundaries = _ref2.boundaries;
	  ...
	  _createClass(Bird, [{
	    ...
	    value: function update(_ref3) {
	      ...
	      if (this.type === 'multidirectional') {
	        this.multidirectionalUpdate({ mouseX: mouseX, mouseY: mouseY });
	      } else if ('unidirectional') {
	        this.unidirectionalUpdate();
	      }
	    }
	  }, {
	    key: 'unidirectionalUpdate',
	    value: function unidirectionalUpdate() {
	    ...
	    key: 'multidirectionalUpdate',
	    value: function multidirectionalUpdate(_ref4) {
	    ...
	    key: 'updateTurn',
	    value: function updateTurn(_ref6) {
	      var mouseX = _ref6.mouseX,
	          mouseY = _ref6.mouseY,
	          oldX = _ref6.oldX,
	          oldY = _ref6.oldY;

	      // check if approaching mouse or wall, then add or subtract to turn accordingly
	      var _ref7 = [this.x, this.y],
	          x = _ref7[0],
	          y = _ref7[1];

	      var turnChange = 0;

	      var oldMouseDistance = this.getDistance(oldX, oldY, mouseX, mouseY);
	      var newMouseDistance = this.getDistance(x, y, mouseX, mouseY);
	    ...
	    key: 'updateFlapFrame',
	    value: function updateFlapFrame() {
	    ...
	    key: 'draw',
	    value: function draw(x, y, flapAmount, rotationAngle, size) {
	      this.drawWing();
	    }
	  }, {
	    key: 'drawWing',
	    value: function drawWing() {
	      var x = this.x,
	          y = this.y,
	          flapAmount = this.flapAmount,
